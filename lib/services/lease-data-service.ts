...
export function enhanceLeasedBuildingsWithMultipleLeases(buildings: TBuilding[]): EnhancedLeasedBuildingWithMultipleLeases[] {
  const leasesByLocation = getLeasesByLocation();
